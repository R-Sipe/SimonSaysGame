...
namespace SimonSaysGame
{
    ...
    {
        string _title = @"
  _      __    __                    ______       _____                  ____              __
 | | /| / ___ / _______  __ _ ___   /_  _____    / __(___ _ ___  ___    / _____ ___ _____ / /
 | |/ |/ / -_/ / __/ _ \/  ' / -_)   / / / _ \  _\ \/ /  ' / _ \/ _ \  _\ \/ _ `/ // (_-</_/ 
 |__/|__/\__/_/\__/\___/_/_/_\__/   /_/  \___/ /___/_/_/_/_\___/_//_/ /___/\_,_/\_, /___(_)  
                                                                               /___/         
";
        string _instructions = "Copy Simon's pattern with your arrow keys, goodluck and keep up!\n\n" +
            "Press any key to start.";




        //string _score = $"Score: {Convert.ToString(_simonGame._scoreCounter)}";
...
";
        ...
        //method to display default string (no directions highlighted) until other action is taken
        ...
        {
            Console.ForegroundColor = ConsoleColor.Cyan;
            int score = _simonGame.ReturnScoreCounter(); Console.WriteLine($"Your final score was: {score}\n\n" +
            "Thanks for playing!\n\n" +
